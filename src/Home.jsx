    ...
    <>
      <div className='flex h-dvh w-full flex-col'>
        ...
        <div className='flex w-full flex-col flex-wrap items-center justify-center gap-5 pt-5 sm:flex-row'>
          <Destaque
            onClick={() => navigate('/bazar/1')}
            img={amigos}
            titulo={destaque1.titulo}
            descricao={destaque1.descricao}
          />
          <Destaque
            onClick={() => navigate('/bazar/12')}
            img={amizade}
            titulo={destaque2.titulo}
            descricao={destaque2.descricao}
          />
          <Destaque
            onClick={() => navigate('/bazar/24')}
            img={nina}
            titulo={destaque3.titulo}
            descricao={destaque3.descricao}
          />
        </div>
